...
export const Room6: React.FC<RoomComponentProps> = ({
  onSuccess,
  onTroll,
  soundEnabled,
}) => {
  ...
  const handleRedClick = () => {
    ...
    setTimeout(() => {
      onTroll(
        "You really trust the instructions?",
        "Rule #1 of ELZZUP: Instructions are not your friends.",
        "ERR_BLIND_OBEDIENCE // FAKE_DIRECTIVE"
      );
    }, 350);
  };
  ...
  const handleBlueClick = () => {
    ...
    setTimeout(() => {
      onSuccess("Good. You're learning.", "Questioning authority is a feature, not a bug.");
    }, 450);
  };

  return (
    <div className="relative w-full h-full flex items-center justify-center p-4 geo-dots-bg select-none">
      {/* Center Dual Button Pedestal Layout */}
      <div className="relative z-10 flex flex-col items-center justify-center">
        ...
        <div className="mb-4 px-4 py-1.5 bg-black/60 border-2 border-black font-mono text-xs text-[#a0a0d0] uppercase tracking-widest flex items-center gap-2 shadow-[2px_2px_0_0_#000]">
          ...
          <span className="font-bold text-[#f0f0ff]">TRUST PROTOCOL // CHAMBER_06</span>
        </div>

        {/* Dual Pedestals */}
        <div className="flex items-center gap-6 sm:gap-12 flex-wrap justify-center">
          {/* 1. RED BUTTON (The Traitor) */}
          <div className="flex flex-col items-center">
            <div className="relative p-4 sm:p-6 bg-[#2a2a4a] border-8 border-black shadow-[0_12px_0_0_#000] flex items-center justify-center">
              ...
              <button
                ...
                title="Press the Red Button (as instructed?)"
                className={`
          ...
          {/* 2. BLUE BUTTON (The True Rebel Solution) */}
          <div className="flex flex-col items-center">
            <div className="relative p-4 sm:p-6 bg-[#2a2a4a] border-8 border-black shadow-[0_12px_0_0_#000] flex items-center justify-center">
              <div className="absolute inset-2 border-2 border-black pointer-events-none" />
